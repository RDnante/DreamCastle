...
<div class="col-12">
    <div class=" heading-center section-heading-animate">
        <div class="section-subheading">Veuillez repondre aux question</div>
        <h3>Test</h3>
    </div>
</div>
<!-- Begin bread crumbs -->	
<form action="#!" method="post" class=" contact-form contact-form-padding" >
<div class="card"  style="width: 500px; height: auto; text-align: center; margin: auto; margin-top: 5px ; margin-bottom: 5px;">
    <div class="control">
        <div>
            Inona no tinao.?
        </div>
...
<div style="width: 500px; height: auto; text-align: center; margin: auto; margin-top: 10px ; margin-bottom: 5px;">
